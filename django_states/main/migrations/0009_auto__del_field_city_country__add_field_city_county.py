...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'main_city', 'country')

        # Adding field 'City.county'
        db.add_column(u'main_city', 'county',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'main_city', 'country',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True),
                      keep_default=False)

        # Deleting field 'City.county'
        db.delete_column(u'main_city', 'county')
