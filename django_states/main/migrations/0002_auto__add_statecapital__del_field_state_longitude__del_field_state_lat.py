...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'State.capital_population'
        db.delete_column(u'main_state', 'capital_population')

        # Adding field 'State.abbreviation'
        db.add_column(u'main_state', 'abbreviation',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'State.capital_population'
        db.add_column(u'main_state', 'capital_population',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'State.abbreviation'
        db.delete_column(u'main_state', 'abbreviation')
